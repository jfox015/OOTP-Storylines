...
class Migration_Install_storylines extends Migration {
	...
	public function up() 
	{
		...
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(10,'WORLD_MONTH_MIN',0,12,'', 0, '', '', 1, 8, 1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(11,'WORLD_MONTH_MAX',0,12,'', 0, '', '', 1, 8, 1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(12,'WORLD_MONTH',0,12,'', 0, '', '', 1, 8, 1)");
		...
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(22,'PERSON_LOYALTY_MIN',0,200,'Player X must have Loyalty rating is at least/below X (on the 1-200 scale)', 0, '', '', 1, 2, 1)");
		...
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(36,'PLAYER_SEASON_PERFORMANCE_MIN',-25,25,'players VORP is not in the top 5 of players on active roster', 0, '', '', 1, 2, 1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(37,'PLAYER_SEASON_PERFORMANCE_MAX',-25,25,'', 1, '', '', 1, 2, 1)");
		...
		$this->db->query("INSERT INTO {$prefix}list_storylines_conditions VALUES(55,'PLAYER_PRO_SERVICE_MIN',0,99,'player has accrued no professional service time', 0, '', '', 1, 2, 1)");
		...
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(6, 'morale_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(7, 'suspension_games', '','',2,2,0,0,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(8, 'talent_increase', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(9, 'talent_decrease', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(10, 'player_local_popularity_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(11, 'player_national_popularity_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(12, 'player_weight_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(13, 'team_fan_interest_modifier', '','',5,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(14, 'team_fan_loyalty_modifier', '','',5,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(15, 'team_market_size_modifier', '','',5,1,1,200,'','',1)");
		...
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(20, 'team_chemistry', '','',5,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(21, 'player_intelligence_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(22, 'player_leader_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(23, 'player_work_ethic_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(24, 'player_greed_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(25, 'player_loyalty_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(26, 'player_play_for_winner_modifier', '','',3,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(27, 'player_pressure_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(28, 'player_speed_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(29, 'player_defense_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(30, 'pitching_stamina_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(31, 'pitching_control_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(32, 'pitching_movement_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(33, 'pitching_velocity_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(34, 'hitting_contact_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(35, 'hitting_power_modifier', '','',4,1,1,200,'','',1)");
		$this->db->query("INSERT INTO {$prefix}list_storylines_results VALUES(36, 'hitting_eye_modifier', '','',4,1,1,200,'','',1)");
