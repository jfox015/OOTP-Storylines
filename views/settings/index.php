...
<div class="admin-box">
    ...
    <h3><?php lang('mod_settings_title'); ?></h3>

    <?php echo form_open($this->uri->uri_string(), 'class="form-horizontal"'); ?>

    <fieldset>
        <legend><?php echo lang('sl_settings_header'); ?></legend>
	...
	<div class="form-actions">
		<input type="submit" name="submit" class="btn btn-primary" value="<?php echo lang('mod_act_settings_saved'); ?>" />
	</div>
